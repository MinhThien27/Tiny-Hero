...
public class PlayerDetector : MonoBehaviour
{
    ...
    [SerializeField] float attackRange = 1f; //Range that enemy can attck player
    ...
    private void Awake()
    {
        Player = GameObject.FindGameObjectWithTag("Player").transform; //Get the player object by tag("Player")
